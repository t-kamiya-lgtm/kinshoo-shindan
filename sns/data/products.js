...
export const PRODUCTS = {
  monster: {
    ...
    cookedWeightG: 90,
    // アレルギー表示は商品ごとに異なる。モンスターの工場でそばは製造していない。
    allergyNotes: [
      '※本品製造工場では、小麦・大豆を含む製品を生産しています。豆類にアレルギーのある方はご注意ください。'
    ],
    nutrition: {
      kcal: 201.3,
      protein: 31.7,
  ...
  sova: {
    ...
    boilRange: [3, 5],     // 計算用。レシピの調理時間の換算に使う
    cookedWeightG: 150,
    // ソバは原材料そのものにそばを含む。工場の表示とは別に必ず併記する。
    allergyNotes: [
      '※本品は、原材料にそばを含みます。',
      '※本品製造工場では、小麦・大豆を含む製品を生産しています。豆類にアレルギーのある方はご注意ください。'
    ],
...
export const COMMON = {
  ...
  cautions: [
    // 製造工場で扱うのは小麦・大豆。そばを含むのは SOVA の原材料側で、
    // 工場の表示ではない。SKU ごとの allergyNotes を使うこと。
    '本品製造工場では、小麦・大豆を含む製品を生産しています。',
...
export const DATA_NOTES = [
  'アレルギー表示を修正しました。当初は全商品に「製造工場ではそば・大豆を含む製品を生産」と記載していましたが、製造工場で扱うのは小麦・大豆です。そばを含むのは SOVA の原材料であり、工場の表示ではありません（2026-07-31 クライアント確認）。',
